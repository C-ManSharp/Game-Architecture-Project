...
/*
Edited by Connor Tall. Added object manager and level manager member variables.
added getters for the object manager and level manager variables so that components can access these variables.
*/
...
public:
	...
	ObjectManager& getGameObjectManager();
