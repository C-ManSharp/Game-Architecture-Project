...
ObjectManager& Game::getGameObjectManager()
{
...
ErrorType Game::StartOfGame()
{
   ...
   // **********************************************************************
	...
	levelManager = objectFactory.createLevelManager();
	if (levelManager)
	{
		objectManager->addGameObject(levelManager);
...
ErrorType Game::Update()
{
   ...
   // Your code goes here *************************************************
   // *********************************************************************
	objectManager->updateGameObjects((float)gt.mdFrameTime);
	objectManager->checkAllCollisions();
	levelManager->update((float)gt.mdFrameTime);
	objectManager->deleteGameObject();
	gt.mark();
